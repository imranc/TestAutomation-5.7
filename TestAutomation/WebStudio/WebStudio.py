...
Examples:
  WebStudio.py login_tests                        # Run all tests in a directory
  WebStudio.py login_tests/valid_login.text       # Run tests in a specific file
  WebStudio.py --variable BROWSER:IE login_tests  # Override variable
  WebStudio.py -v BROWSER:IE -v DELAY:0.5 login_tests
  WebStudio.py --variable SUT:flex login_tests
...
def print_usage():
    print 'Usage: WebStudio.py [options] datasource'
    print '   or: WebStudio.py demoapp start|stop'
    print '   or: WebStudio.py selenium start|stop'
    print '   or: WebStudio.py help'
