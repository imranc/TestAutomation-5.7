...
class _BrowserManagementKeywords(KeywordGroup):
    ...
    def getMsAddress(self):
        ece_host= os.environ['ECE_EDITORIAL_HOST']
        ece_port= os.environ['ECE_EDITORIAL_PORT']
        ece_ms_address= 'http://'+ece_host+':'+ece_port+'/mobile-studio'
        return ece_ms_address

    def getLcAddress(self):
        ece_host= os.environ['ECE_EDITORIAL_HOST']
        ece_port= os.environ['ECE_EDITORIAL_PORT']
        ece_lc_address= 'http://'+ece_host+':'+ece_port+'/live-center'
        return ece_lc_address

    def getEscenicAdminAddress(self):
        ece_host= os.environ['ECE_EDITORIAL_HOST']
        ece_port= os.environ['ECE_EDITORIAL_PORT']
        ece_ea_address= 'http://'+ece_host+':'+ece_port+'/escenic-admin'
        return ece_ea_address
